...
from model import Transformer, Autoformer, Informer, Timesnet
...
class Exp_Formers(Exp_Basic):
    def __init__(self, args):
        super(Exp_Formers, self).__init__(args)
    ...
    def _select_optimizer(self):
        ...
        # ts_block_params = list(self.model.sea_block.parameters()) # + list(self.model.trend_block.parameters())
        ...
        # #
        # fusion_params = list(self.model.multi_modal_graph.parameters() )+ list(self.model.modal_fusion.parameters())
        ...
        #     {'params': rs_block_params, 'lr': 1e-6},
        #     {'params': fusion_params, 'lr': 1e-6},
        #     {'params': other_params},
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                # decoder input
                dec_inp = torch.zeros_like(batch_y[:, -self.args.label_len:, :]).float().to(self.device)
